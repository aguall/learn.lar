    ...
    <div class="container">
        <table class="table table-bordered">
            ...
            <tr class="form_row">
                ...
                <td>
                    <input type="text" name="name" class="name form-control" value="{{$users->name}}"/>
                </td>
                <td>
                    <input type="text" name="firstname" class="firstname form-control" value="{{$users->firstname}}"/>
                </td>
                <td>
                    <input type="text" name="Phone" class="Phone form-control" value="{{$users->Phone}}"/>
                </td>
                <td>
                    <input type="text" name="City" class="City form-control" value="{{$users->City}}"/>
                </td>
                <td style="text-align: center;">
                    <input name="activity" type="checkbox" class="activity" {{ $users -> activity == 1?'checked':'' }}/>
                </td>
                <td>
                ...
                <td>
                    @if($users -> image_url)
                    <div class="file-upload" style="background-image: url('../{{$users -> image_url}}');">
                        <label>
                            <input type="file" name="image" src="../{{$users -> image_url}}" class="image" >
                        </label>
                    </div>
                ...
                <td style="text-align: center;">
                    <i style="cursor:pointer;margin-right:10px;color:gray;" class="glyphicon glyphicon-ok updateBtn btn" active="false" onclick="updateRow($(this).closest('tr'),'{{$users -> id}}')"></i>
                    <i style="color:red;" class="glyphicon glyphicon-remove btn" onclick="modalDelete('{{$users -> id}}','{{ Auth::user()->role }}')"></i>
                </td>
            </tr>
